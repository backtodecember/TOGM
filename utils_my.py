...
def trajectory_loader(start,end,dt,number):
	...
	if number == 2:
		...
		np.save('results/PID_trajectory/4/q_init_guess.npy',np.array(q))
		np.save('results/PID_trajectory/4/q_dot_init_guess.npy',np.array(q_dot))
		np.save('results/PID_trajectory/4/u_init_guess.npy',np.array(u))
		np.save('results/PID_trajectory/4/time_init_guess.npy',np.array(time))
